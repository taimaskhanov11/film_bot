...
from film_bot.apps.bot.callback_data.base_callback import ChatCallback, FilmCallback
from film_bot.apps.bot.markups.utils import get_inline_keyboard, get_inline_url_keyboard
...
def admin_start():
    keyword = [
        ...
        (("🎥 Список текущих фильмов.", FilmCallback(action="view_all").pack()),),
        (("🎥 Добавить фильм.", FilmCallback(action="create").pack()),),
